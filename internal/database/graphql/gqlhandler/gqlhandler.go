...
func (ec *executionContext) unmarshalInputUpdateGuildAdminConfigInput(ctx context.Context, obj interface{}) (ent.UpdateGuildAdminConfigInput, error) {
	...
	fieldsInOrder := [...]string{"updateTime", "clearEnabled", "enabled", "clearDefaultMaxChannels", "defaultMaxChannels", "clearDefaultMaxClones", "defaultMaxClones", "clearComment", "comment"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateGuildConfigInput(ctx context.Context, obj interface{}) (ent.UpdateGuildConfigInput, error) {
	...
	fieldsInOrder := [...]string{"updateTime", "clearEnabled", "enabled", "clearDefaultMaxClones", "defaultMaxClones", "clearRegexMatch", "regexMatch", "clearContactEmail", "contactEmail"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
