...
func (r *queryResolver) Guilds(ctx context.Context, after *entgql.Cursor[int], first *int, before *entgql.Cursor[int], last *int, orderBy *ent.GuildOrder, where *ent.GuildWhereInput) (*ent.GuildConnection, error) {
...
func (r *queryResolver) GuildAdminConfigs(ctx context.Context, after *entgql.Cursor[int], first *int, before *entgql.Cursor[int], last *int, where *ent.GuildAdminConfigWhereInput) (*ent.GuildAdminConfigConnection, error) {
...
func (r *queryResolver) GuildConfigs(ctx context.Context, after *entgql.Cursor[int], first *int, before *entgql.Cursor[int], last *int, where *ent.GuildConfigWhereInput) (*ent.GuildConfigConnection, error) {
...
func (r *queryResolver) GuildEvents(ctx context.Context, after *entgql.Cursor[int], first *int, before *entgql.Cursor[int], last *int, orderBy *ent.GuildEventOrder, where *ent.GuildEventWhereInput) (*ent.GuildEventConnection, error) {
